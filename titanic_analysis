...
# ── 5. NUMPY STATS ──────────────────────────────────────────
ages = df["Age"].values  # NumPy array
...
# — Plot 6: Embarkation Port Survival —
...
plt.savefig("/mnt/user-data/outputs/titanic_analysis.png", dpi=150, bbox_inches="tight")
